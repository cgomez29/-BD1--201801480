...
CREATE TABLE ADDRESS(
    ...
    distric             VARCHAR(100)    NOT NULL, /*REVISAR SI VIENEN DISTRITOS*/ 
...
ALTER TABLE EMPLOYEE 
    ADD CONSTRAINT employee_shop_fk FOREGING KEY(shop_id)
        REFERENCES SHOP(shop_id);

ALTER TABLE EMPLOYEE 
    ADD CONSTRAINT employee_employee_fk FOREGING KEY(manager_id)
        REFERENCES EMPLOYEE(employee_id);

ALTER TABLE EMPLOYEE 
    ADD CONSTRAINT employee_address_fk FOREGING KEY(address_id)
        REFERENCES ADDRESS(address_id);
...
CREATE TABLE RENTAL_MOVIE(
    rental_movie_id     NUMBER GENERATE BY DEFAULT ON NULL AS IDENTITY,
    rental_date         TIMESTAMP   NOT NULL,
    return_date         TIMESTAMP   NOT NULL,
    movie_id            NUMBER      NOT NULL, /*PENDIENTE*/
...
ALTER TABLE RENTAL_MOVIE 
    ADD CONSTRAINT rental_movie_movie_fk FOREIGN KEY(movie_id)
...
ALTER TABLE MOVIE_ACTOR 
    ADD CONSTRAINT movie_actor_actor_fk ACTOR(actor_id);
...
ALTER TABLE INVENTORY    
    ADD CONSTRAINT inventory_movie_fk FOREING KEY(movie_id)
        REFERENCES MOVIE(movie_id);


-- ==================================================================================================
-- Creation of the SHOP_INVENTORY table 
-- ==================================================================================================

CREATE TABLE SHOP_INVENTORY(
    shop_inventory_id        NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY. 
    inventory_id            NUMBER NOT NULL,
    shop_id                 NUMBER NOT NULL
);

ALTER TABLE SHOP_INVENTORY 
    ADD CONSTRAINT shop_inventory_pk PRIMARY KEY(shop_inventory_id);

ALTER TABLE SHOP_INVENTORY    
    ADD CONSTRAINT shop_inventory_inventory_fk FOREING KEY(inventory_id)
        REFERENCES INVENTORY(inventory_id);

ALTER TABLE SHOP_INVENTORY    
    ADD CONSTRAINT shop_inventory_shop_fk FOREING KEY(shop_id)
        REFERENCES SHOP(shop_id);
