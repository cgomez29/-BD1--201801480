...
-- ==================================================================================================
-- Creation of the MOVIE_CATEGORY table 
-- ==================================================================================================


CREATE TABLE MOVIE_CATEGORY(
    movie_category_id       NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
ALTER TABLE MOVIE_CATEGORY
    ADD CONSTRAINT movie_category_movie_fk FOREIGN KEY(movie_id)
        REFERENCES MOVIE(movie_id) ON DELETE CASCADE;

ALTER TABLE MOVIE_CATEGORY
    ADD CONSTRAINT movie_category_category_fk FOREIGN KEY(category_id)
        REFERENCES CATEGORY(category_id) ON DELETE CASCADE;
